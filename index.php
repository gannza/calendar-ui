...
<div class="calendar-position">
		<div class="calendar-body">
			<div><div id="previous" data-id="<?php echo $doctor_id?>"><span class="iconify arrow" data-icon="dashicons:arrow-left-alt2" data-inline="false"></span></div></div>
			...
			<div><div id="next"  data-id="<?php echo $doctor_id?>"><span class="iconify arrow" data-icon="dashicons:arrow-right-alt2" data-inline="false"></span></div></div>
		</div>
	</div>


<script>
init(<?php echo $doctor_id ?>);
</script>
